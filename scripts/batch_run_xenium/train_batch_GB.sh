...
PROJECT_NAME="Neuronal_Panel" # this is the folder tag for the datasets DATA_ROOT/PROJECT_NAME and the folder in MODELS_ROOT where the models are gonna be saved
