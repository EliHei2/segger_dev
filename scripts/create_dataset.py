...
if __name__ == "__main__":
    ...
    parser.add_argument("--raw_data_dir", type=str, required=True, help="Directory to store raw data.")
    parser.add_argument("--processed_data_dir", type=str, required=True, help="Directory to store processed data.")
    parser.add_argument("--transcripts_url", type=str, required=True, help="URL for transcripts data.")
    parser.add_argument("--nuclei_url", type=str, required=True, help="URL for nuclei data.")
    parser.add_argument("--min_qv", type=int, default=30, help="Minimum quality value for filtering transcripts.")
    parser.add_argument("--d_x", type=int, default=180, help="Step size in x direction for tiles.")
    parser.add_argument("--d_y", type=int, default=180, help="Step size in y direction for tiles.")
