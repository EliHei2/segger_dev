...
sns.boxplot(data=cell_area_log2_data, 
            x='Segmentation Method', 
            y='Cell Area (log2)', 
            palette=method_colors,
            showfliers=False,
            showcaps=False,
            flierprops={"marker": "x"})  # Hide the default outliers in the boxplot
...
mcer_methods_final = method_colors.keys()
sensitivity_boxplot_data = sensitivity_boxplot_data[sensitivity_boxplot_data['Segmentation Method'].isin(mcer_methods_final)]


plt.figure(figsize=(2.5, 4))
sns.boxplot(data=sensitivity_boxplot_data, 
            x='Segmentation Method', 
            y='Sensitivity', 
            palette=method_colors,
            showfliers=False,
...
# Create the boxplot with the size 4x6 inches and show only the outliers
plt.figure(figsize=(2.5, 4))
sns.boxplot(data=mcer_data_filtered, 
            x='Segmentation Method', 
            y='MECR', 
            palette=method_colors,
            showfliers=False,
