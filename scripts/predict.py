...
def main(args: argparse.Namespace) -> None:
    ...
    """
    litsegger = load_model(args.checkpoint_path, args.init_emb, args.hidden_channels, args.out_channels, args.heads, args.aggr)
    predict(litsegger, args.dataset_path, args.output_path, args.score_cut, args.k_nc, args.dist_nc, args.k_tx, args.dist_tx)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--score_cut', type=float, default=0.5, help='Score cut-off for predictions')
    parser.add_argument('--k_nc', type=int, default=4, help='Number of nearest neighbors for nuclei')
    ...
    parser.add_argument('--dist_tx', type=int, default=10, help='Distance threshold for transcripts')
