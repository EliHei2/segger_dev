...
@click.option('--sample_type', type=str, default=None, help='The sample type of the raw data, e.g., "xenium" or "merscope".')
@click.option('--k_bd', type=int, default=3, help='Number of nearest neighbors for boundary nodes.')
@click.option('--dist_bd', type=float, default=15., help='Maximum distance for boundary neighbors.')
@click.option('--k_tx', type=int, default=3, help='Number of nearest neighbors for transcript nodes.')
@click.option('--dist_tx', type=float, default=5., help='Maximum distance for transcript neighbors.')
@click.option('--tile_size', type=int, default=None, help='If provided, specifies the size of the tile. Overrides `tile_width` and `tile_height`.')
@click.option('--tile_width', type=int, default=None, help='Width of the tiles in pixels. Ignored if `tile_size` is provided.')
@click.option('--tile_height', type=int, default=None, help='Height of the tiles in pixels. Ignored if `tile_size` is provided.')
@click.option('--neg_sampling_ratio', type=float, default=5., help='Ratio of negative samples.')
@click.option('--frac', type=float, default=1., help='Fraction of the dataset to process.')
