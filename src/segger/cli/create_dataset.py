...
def create_dataset(args: Namespace, dataset_dir: Path, data_dir: Path, sample_tag: str, 
                   transcripts_file: str, boundaries_file: str, x_size: int, y_size: int, 
                   d_x: int, d_y: int, margin_x: int, margin_y: int, r_tx: int, k_tx: int, 
                   val_prob: float, test_prob: float, neg_sampling_ratio: float, 
                   sampling_rate: float, workers: int, gpu: bool):
