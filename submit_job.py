...
def run_data_processing():
    subprocess.run([
        ...
        config['paths']['singularity_image'], "python3", "src/segger/cli/create_dataset_fast.py",
...
def run_training():
    subprocess.run([
        ...
        f"{config['paths']['local_repo_dir']}:{config['paths']['container_dir']}",
        "--pwd", config['paths']['container_dir'],
        config['paths']['singularity_image'], "python3", "src/segger/cli/train_model.py",
...
def run_prediction():
    subprocess.run([
        ...
        f"{config['paths']['local_repo_dir']}:{config['paths']['container_dir']}",
        "--pwd", config['paths']['container_dir'],
        config['paths']['singularity_image'], "python3", "src/segger/cli/predict.py",
